...
| `global-coop-coordinator-tree.js` | Global Coop sidebar execution hierarchy | Exact bounded projection of Lead-resident ProjectRef-bound coordinators → target-project task coordinators → current bound worker sessions, with canonical TaskRef/SessionRef ownership and active/attention visibility gates |
