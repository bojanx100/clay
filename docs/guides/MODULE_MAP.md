...
| `coop-topic-projection.js` | ACL-safe client shaping of durable Threads | Bounded lifecycle metadata, summary-only membership, and related work reduced to top-level canonical project-session links |
