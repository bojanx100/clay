...
| `coop-handoff-traces.js` | Atomic, bounded runtime evidence store for Coop handoffs: records normalized direct-owner intent plus authorized stable navigation only; rejects malformed state and never persists conversation text, prompts, transcripts, or summaries |
