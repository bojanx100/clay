...
| `voice-questions.js` (server) | `voice_question_state_request`, `voice_question_answer` | Discovers live Claude/Codex questions and validates the exact session, instance revision and answer before calling the existing response path |
