...
│   └── TASK_LAUNCHERS.md               Project-defined task recipes, GitHub issue launchers, dashboard launch API
├── roadmaps/
│   ├── completed/
...
│       └── VOICE-CONVERSATION-ROADMAP.md  PWA voice, multi-AI rooms, Android decision gates
└── README.md                           This file
```
