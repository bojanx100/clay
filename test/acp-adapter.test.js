...
test("new ACP vendor factories satisfy the shared YOKE contract", function() {
  // Clay's production Copilot route uses the richer GitHub Copilot adapter;
  // the generic profile remains covered below as an ACP permission fixture.
  var vendors = ["opencode", "kimi", "grok", "qwen", "junie"];
