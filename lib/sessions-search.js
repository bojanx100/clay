...
function attachSessionSearch(ctx) {
  ...
  function searchSessions(query) {
    ...
    sessions.forEach(function (session) {
      ...
      // Searching every transcript is the one operation that legitimately reads
      // all of them. Release whatever this scan paged in, or a single search
      // would leave the whole corpus resident and undo the lazy load.
      ...
      if (!wasResident) historyStore.release(session);
