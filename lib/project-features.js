...
function attachProjectFeatures(ctx) {
  ...
  // Migrate automation claims left behind by the previous run before any tick
  // can fire, so in-flight work is adopted rather than double-started.
  try { autoLaunch.reconcileAutomationClaims(); } catch (e) {}
