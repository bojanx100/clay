...
function explicitItemApproval(text) {
  ...
  // and must not turn an explicit approval into a hypothetical. Questions and
  // actual deferrals still fail above for the whole turn.
  return { subject: remainder.split(",")[0].trim() };
}
