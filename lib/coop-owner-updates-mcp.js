...
function createConversationServer(adapter, manager, session) {
  ...
  var defs = [tool("list_coop_feedback", "List task, planning and proactive review references not yet included " +
    "in an owner update. A review reference proves its discussion scope, not a finding or completed work. " +
    "Read and reconcile the actual evidence before reporting it.", {}, function () {
