...
function createProjectContext(opts) {
  ...
  var _status = attachProjectStatus({
    cwd: cwd,
    slug: slug,
    project: project,
  ...
  projectTimers.externalCodexSyncTimer = setInterval(function () {
  ...
  if (projectTimers.externalCodexSyncTimer && typeof projectTimers.externalCodexSyncTimer.unref === "function") projectTimers.externalCodexSyncTimer.unref();
