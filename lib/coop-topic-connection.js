...
function handleOwnerRequestOverview(ctx, ws, msg) {
  ...
  var sessionLedger = ctx.coopSessionLedger || ctx.opts && ctx.opts.coopSessionLedger || null;
  var overview;
  try {
    overview = ownerRequestQuery.overviewFrom(ledger, sessionLedger, topicIndexForContext(ctx, ws));
  } catch (e) {
