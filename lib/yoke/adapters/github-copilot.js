...
var {
  ...
  textFromContentList, imagesFromContentList, textFromRawToolOutput,
  imagesFromRawToolOutput, runtimeMetadataPrompt, isCopilotAuthError,
  isCopilotQuotaError,
...
function createGitHubCopilotAdapter(opts) {
  ...
  return {
    ...
    createQuery: function(queryOpts) {
      if (queryOpts && queryOpts.readOnlyExecution) require("../read-only-query").apply({}, "github-copilot");
