...
var copilotHelpers = require("./github-copilot-helpers");
...
function createAcpAdapter(vendor, opts) {
  ...
  var slug = opts.slug || "";
  var defaultInitOpts = Object.assign({}, opts);
  ...
  var adapter = {
    ...
    init: function(initOpts) {
      ...
      defaultInitOpts = copilotHelpers.retainClayConnectionOptions(defaultInitOpts, initOpts);
      ...
      initPromise = (async function() {
        ...
        var effectiveOpts = Object.assign({}, defaultInitOpts, initOpts || {});
    ...
    createQuery: async function(queryOpts) {
      queryOpts = Object.assign({}, defaultInitOpts, queryOpts || {});
      ...
      var mcpServers = [];
      if (Array.isArray(queryOpts.mcpServers)) mcpServers = mcpServers.concat(queryOpts.mcpServers);
      if (Array.isArray(acpOptions.mcpServers)) mcpServers = mcpServers.concat(acpOptions.mcpServers);
      mcpServers = copilotHelpers.acpMcpServersWithClayBridge(mcpServers, queryOpts, slug);
      var handle = null;
