...
var getProjectLastVendor = preferences.getProjectLastVendor;
var setProjectLastVendor = preferences.setProjectLastVendor;
var getClaudeOpenMode = preferences.getClaudeOpenMode;
var setClaudeOpenMode = preferences.setClaudeOpenMode;
var getLegacyLeadMode = preferences.getLegacyLeadMode;
// Compatibility read for integrations that formerly asked users.js for a
// per-user setting. The argument is intentionally ignored: Lead mode is now
// one Clay-wide value and writes must go through the authorized WS handler.
function getLeadMode() {
  return leadMode.getLeadMode({ usersModule: module.exports });
}
...
var getWorkspaceGroupStates = preferences.getWorkspaceGroupStates;
var setWorkspaceGroupStates = preferences.setWorkspaceGroupStates;
