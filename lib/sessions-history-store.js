...
//
// `session.history.length` looks harmless and is not: on a released lazy
// session the accessor re-reads and parses the entire .jsonl from disk. Doing
// that to answer a question as small as "is this non-empty?" is how a boolean
// ends up costing a multi-megabyte read on the session-switch path.
