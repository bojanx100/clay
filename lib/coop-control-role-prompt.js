...
function rolePrompt(context) {
  ...
  if (context.role === "coop") {
    return "You are Coop, the owner's lead and discussion partner. Own high-level reasoning, planning, " +
      ...
      "outcomes and blockers. Delegate substantial project execution to the bound project coordinators; " +
      ...
      "reference and Thread in the task. Offer direct session access when useful or requested. " + common;
  }
...
function prepareControlTurn(ctx, session, text) {
  ...
  return { systemPrompt: prompt, text: prompt + "\n\n<clay_control_context>\n" +
