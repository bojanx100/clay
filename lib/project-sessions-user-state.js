function attachProjectSessionsUserState(ctx) {
  ...
  function handleUserStateMessage(ws, msg) {
    ...
    if (msg.type === "set_lead_mode") {
      ...
      var lmState = lmResult && lmResult.state ? lmResult.state : leadMode.publicState(leadMode.getLeadModeState({ usersModule: usersModule }));
      var lmCanChange = leadMode.isAuthority(ws._clayUser || null,
        !!(usersModule && usersModule.isMultiUser && usersModule.isMultiUser()));
