...
// Events that are the assistant actually saying something, as opposed to the
// turn's own bookkeeping. A `done` with no such event before it terminated a
// turn that produced no reply, whatever its exit code claims.
