...
function createSessionManager(opts) {
  ...
  // Normalize only never-started Coop records from older versions during load.
  // Opening a page never performs this durable model migration.
  sessions.forEach(function (session) {
    require("./coop-model-routing").initializeSession(session, saveSessionFile);
  });
