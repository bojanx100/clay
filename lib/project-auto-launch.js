...
function attachAutoLaunch(ctx) {
  ...
  async function launchScheduled(recipeId, extraArgs) {
    ...
    // One unguessable generation covers this fetch and the synchronous checks
    // below. It is passed straight into admission after the scan; no age or TTL
    // can turn evidence from an older scan into current authority.
