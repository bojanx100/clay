...
function createTopicIndex(options) {
  ...
  return { load: load, save: save, ensureRetro: ensureRetro, reconcileTopicAnchors: reconcileTopicAnchors, retrofitTopicTitles: retrofitTopicTitles, rename: rename, move: move, merge: merge, split: split, close: function (ref) { return changeStatus(ref, "closed"); }, reopen: function (ref) { return changeStatus(ref, "open"); }, addEventMembership: addEventMembership, linkExecution: linkExecution, resolveCanonicalEvent: resolveCanonicalEvent, project: project, validateIngress: validateIngress, classifyCanonicalIngress: classifyCanonicalIngress, resolve: resolve, file: file };
}
