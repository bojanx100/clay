...
function createTopicIndex(options) {
  ...
  return {
    ...
    merge: function (target, sources) { return mutate({ ok: false, code: "persistence_failed" }, function () { return merge(target, sources); }); },
    split: function (source, parts) { return mutate({ ok: false, code: "persistence_failed" }, function () { return split(source, parts); }); },
    close: function (ref) { return mutate({ ok: false, code: "persistence_failed" }, function () { return changeStatus(ref, "closed"); }); },
    reopen: function (ref) { return mutate({ ok: false, code: "persistence_failed" }, function () { return changeStatus(ref, "open"); }); },
    addEventMembership: function (ref, refs) { return mutate({ ok: false, code: "persistence_failed" }, function () { return addEventMembership(ref, refs); }); },
