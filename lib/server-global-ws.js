...
function attachGlobalWs(opts) {
  ...
  function handleMessage(ws, msg) {
    ...
    if (msg.type === "create_project") {
      var createRequest = resolveCreateProjectRequest(msg, config.REAL_HOME);
      ...
      if (typeof onCreateProject === "function") {
        var createResult = onCreateProject(createRequest.name, ws._clayUser, createRequest.parentPath);
