      ...
      function () {
        ...
        var result = ctx.coordinateExternalTask({
          ...
          ownedPaths: "Live UI report " + reportId +
            (selection && selection.component && selection.component.source ?
              ". Likely component source: " + selection.component.source.file + "." :
              ".") +
        ...
        var task = taskGraph.findTask(session, result.orchestrationTaskId);
        var record = {
          reportId: reportId,
          ...
          workerColor: result.workerColor ||
            (task && task.workerColor) || "#55A7FF",
          autoClosed: false,
        };
