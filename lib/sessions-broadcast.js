...
function attachSessionBroadcast(ctx) {
  ...
  function mapSessionForClient(s, clientActiveId, wsUnread, orchestrationGroups) {
    ...
    return {
      ...
      demotionPending: !!s.demoteCoordinatorWhenIdle,
      orchestrationActiveCount: activeOrchestrationCount,
      orchestrationParent: orchestrationTaskState.orchestrationParentForClient(s),
      orchestrationGroupParent: orchestrationTaskState.orchestrationGroupParentForClient(s, orchestrationGroups),
