  ...
  function handleConnection(ws, wsUser, handleMessage, handleDisconnection) {
    ...
    sendTo(ws, {
      ...
      sessions: allSessions.map(function (s) {
        ...
        }, orchestrationSessionFields(s, orchestrationGroups));
      }),
    });
