...
function attachProjectFoundation(ctx) {
  ...
  var browserExtension = attachProjectBrowserExtension({
    browserState: ctx.browserExtensionState,
    sendTo: sendTo,
  });
  ...
  var schedulerGate = { service: null };
  var taskOrchestrationGate = {
    delegate: null,
    message: null,
    plan: null,
    report: null,
    ...
    retry: null,
    adopt: null,
    listCoopSessions: null,
    steerProjectCoordinator: null,
    migrateControlPlaneBinding: null,
    switchProvider: null,
  };
  ...
  return {
    ...
    getOsUserInfoForLinuxUser: osUserApi.getOsUserInfoForLinuxUser,
