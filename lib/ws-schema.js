...
var schema = {
  ...
  // -----------------------------------------------------------------------
  "ping":                     { direction: "c2s", handler: "lib/project.js", description: "Heartbeat liveness probe; client detects zombie sockets after sleep" },
  "pong":                     { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Heartbeat ack confirming the socket is alive" },

  // -----------------------------------------------------------------------
  // Session management
  // -----------------------------------------------------------------------
  "switch_session":           { direction: "c2s", handler: "lib/project-sessions.js", description: "Switch the active session by local ID" },
  "sync_external_session":    { direction: "c2s", handler: "lib/project-sessions.js", description: "Reconcile the active non-Claude session with an external Codex rollout file" },
  ...
  "hide_session":             { direction: "c2s", handler: "lib/project-sessions.js", description: "Hide a session from the sidebar (keeps it on disk)" },
  ...
  "list_cli_sessions":       { direction: "c2s", handler: "lib/project-sessions.js", description: "List importable Claude/Codex/Copilot CLI sessions for the requested vendor filter (includeCoopManaged also lists closed Coop-owned sessions)" },
  "import_cli_session":      { direction: "c2s", handler: "lib/project-sessions.js", description: "Import a CLI session by cliSessionId (clears tombstone, creates Clay record, releases Coop-owned sessions back to the owner)" },
  "set_session_visibility":   { direction: "c2s", handler: "lib/project-sessions.js", description: "Set a session to shared or private in multi-user mode" },
  ...
  "compact_session":          { direction: "c2s", handler: "lib/project-sessions.js", description: "Create a compacted continuation session from the active session" },
  ...
  "handoff_session":          { direction: "c2s", handler: "lib/project-sessions.js", description: "Switch provider in place while preserving the current Clay session and timeline" },

  "session_list":             { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Full list of sessions for the sidebar" },
  "global_coop_projection":  { direction: "s2c", handler: "Coop global projection client", description: "Read-only ref-only project grouping sent only to the Coop/Lead scope" },
  "coop_owner_sidebar_prioritize": { direction: "c2s", handler: "Coop owner sidebar", description: "Owner-gated durable Next-order change by canonical ThreadRef" },
  "coop_owner_sidebar_priority_result": { direction: "s2c", handler: "Coop owner sidebar", description: "Priority change result and authoritative revision" },
  "coop_owner_ledger_visibility": { direction: "c2s", handler: "Coop owner sidebar", description: "Owner-gated Clear or Restore of one durable owner-ledger projection row" },
  "coop_owner_ledger_visibility_result": { direction: "s2c", handler: "Coop owner sidebar", description: "Clear or Restore result and authoritative ledger revision" },
  "coop_owner_ledger_detail": { direction: "c2s", handler: "Coop owner sidebar", description: "Owner-gated request for one ledger row's canonical original message and provenance" },
  "coop_owner_ledger_detail_result": { direction: "s2c", handler: "Coop owner sidebar", description: "Bounded original-message detail resolved by immutable owner ingress identity" },
  "resolve_session_ref":     { direction: "c2s", handler: "lib/project-connection-handlers.js", description: "Resolve one stable SessionRef to its current project slug and local runtime ID without creating a session" },
  "session_ref_resolved":    { direction: "s2c", handler: "Coop global projection client", description: "Stable SessionRef navigation resolution or deterministic failure" },
  "list_orchestration_coordinators": { direction: "c2s", handler: "lib/project-user-message.js", description: "List eligible owners for an existing session" },
  "orchestration_coordinator_candidates": { direction: "s2c", handler: "lib/public/modules/app-messages-sessions.js", description: "Eligible coordinator picker rows" },
  "propose_session_adoption": { direction: "c2s", handler: "lib/project-user-message.js", description: "Offer an existing session to a coordinator with an explicit adoption intent" },
  "session_adoption_proposed": { direction: "s2c", handler: "lib/public/modules/app-messages-sessions.js", description: "Existing-session adoption acknowledgement" },
  ...
  "cli_session_list":         { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Response to list_cli_sessions: importable CLI sessions plus vendor filter" },
  "cli_session_imported":     { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "An import_cli_session call succeeded" },
  "cli_session_import_failed":{ direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "An import_cli_session call failed" },
  ...
  "user_turn_started":       { direction: "s2c", handler: "lib/public/modules/voice-conversation.js", description: "Actual owner turn dispatch, attributed to its client message ID for Voice reply tracking" },
  ...
  "message_accepted":         { direction: "s2c", handler: "lib/project-user-message-context.js", description: "The user message was appended durably before provider dispatch" },
  "message_failed":           { direction: "s2c", handler: "lib/project-user-message-context.js", description: "The user message could not be persisted or routed" },
  ...
  // Tools
  // -----------------------------------------------------------------------
  "coop_internal_turn_started": { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "A durably queued internal Coop turn begins" },
  "coop_owner_update":        { direction: "s2c", handler: "lib/public/modules/app-messages-stream.js", description: "Durable owner-facing Coop report with exact feedback references" },
  "coop_owner_response_started": { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "A saved automated answer begins its owner-facing response" },
  ...
  "tool_output":              { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Live coalesced command stdout/stderr (ephemeral, not recorded)" },
  "slash_command_result":     { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Output of a slash command" },
  "task_launch":              { direction: "c2s", handler: "lib/project-task-launcher.js", description: "Preview or start project task sessions from .clay/tasks recipes" },
  ...
  // -----------------------------------------------------------------------
  "voice_question_state_request": { direction: "c2s", handler: "lib/project-sessions-permissions.js", description: "Read the exact live pending questions for the current voice destination" },
  "voice_turn_state_request": { direction: "c2s", handler: "lib/project-sessions-permissions.js", description: "Recover the exact previously dispatched voice reply after reconnection" },
  "voice_turn_state": { direction: "s2c", handler: "lib/public/modules/voice-conversation.js", description: "Transcript-backed state and text for an exact voice client turn" },
  "voice_question_state": { direction: "s2c", handler: "lib/public/modules/voice-conversation.js", description: "Current pending voice questions, with instance revisions and unsupported dialog count" },
  "voice_question_answer": { direction: "c2s", handler: "lib/project-sessions-permissions.js", description: "Answer an exact live question revision by voice" },
  "voice_question_answer_result": { direction: "s2c", handler: "lib/public/modules/voice-conversation.js", description: "Whether the exact pending voice answer was applied" },
  ...
  "queued_user_message":      { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "User message queued while a response is active" },
  "queued_user_message_removed": { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Queued user message was sent or removed" },
  "queued_user_messages_cleared": { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Queued user messages were cleared" },
  "steer_queued_message":     { direction: "c2s", handler: "lib/project-user-message.js", description: "Steer a queued message into the active response" },
  "coordinate_queued_message": { direction: "c2s", handler: "lib/project-user-message.js", description: "Ask the current AI to coordinate a queued message with conversation context" },
  "close_orchestration_task": { direction: "c2s", handler: "lib/project-user-message.js", description: "Stop an owned worker task and archive its conversation" },
  "orchestration_tasks_state": { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Current child task projection for the coordinating session" },
  "clear_queued_message":     { direction: "c2s", handler: "lib/project-user-message.js", description: "Clear a queued user message" },
  "set_session_queueing":     { direction: "c2s", handler: "lib/project-user-message.js", description: "Enable/disable message queueing for a session (in-memory, resets on restart)" },
  ...
  "set_automation_mode":      { direction: "c2s", handler: "lib/project-sessions.js", description: "Set the current session automation preset" },
  ...
  "set_server_default_codex_config": { direction: "c2s", handler: "lib/project-sessions.js", description: "Set server-wide default Codex approval, sandbox, and web search" },
  "set_project_default_codex_config": { direction: "c2s", handler: "lib/project-sessions.js", description: "Set project default Codex approval, sandbox, and web search" },
  ...
  "get_project_auto_continue_comparable": { direction: "c2s", handler: "lib/project-sessions.js", description: "Get the current project's comparable-model failover setting" },
  "project_auto_continue_comparable": { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Current project's comparable-model failover setting" },
  "set_project_auto_continue_comparable": { direction: "c2s", handler: "lib/project-sessions.js", description: "Set the current project's comparable-model failover setting" },
  "set_project_auto_continue_comparable_result": { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Result of setting comparable-model failover for a project" },
  "get_project_provider_routing_profile": { direction: "c2s", handler: "lib/project-sessions.js", description: "Get the current project's automatic provider-routing profile" },
  "project_provider_routing_profile": { direction: "s2c", handler: "lib/project-sessions.js", description: "Current project's automatic provider-routing profile" },
  "set_project_provider_routing_profile": { direction: "c2s", handler: "lib/project-sessions.js", description: "Set the current project's automatic provider-routing profile" },
  "set_project_provider_routing_profile_result": { direction: "s2c", handler: "lib/project-sessions.js", description: "Result of setting the automatic provider-routing profile" },
  "get_auto_approval_state": { direction: "c2s", handler: "lib/project-auto-launch.js", description: "Read effective project or Coop auto-approval state" },
  "set_auto_approval_project": { direction: "c2s", handler: "lib/project-auto-launch.js", description: "Set one exact ProjectRef auto-approval override" },
  "clear_auto_approval_project_override": { direction: "c2s", handler: "lib/project-auto-launch.js", description: "Clear one exact ProjectRef auto-approval override" },
  "set_auto_approval_global": { direction: "c2s", handler: "lib/project-auto-launch.js", description: "Set canonical Coop all-projects auto-approval" },
  "auto_approval_state": { direction: "s2c", handler: "lib/public/modules/app-messages-settings.js", description: "Effective auto-approval control state and audit projection" },
  "get_provider_status":      { direction: "c2s", handler: "lib/project-sessions-handoff.js", description: "Read the provider registry, CLI presence, account probe, model verification, and route readiness" },
  "provider_status":          { direction: "s2c", handler: "lib/public/modules/server-settings-providers.js", description: "Dynamic AI provider onboarding and readiness snapshot" },
  "refresh_provider":         { direction: "c2s", handler: "lib/project-sessions-handoff.js", description: "Reinitialize and verify one installed provider runtime" },
  "refresh_vendors":          { direction: "c2s", handler: "lib/project-sessions-handoff.js", description: "Reinitialize and verify every installed provider runtime" },
  ...
  "list_git_accounts":        { direction: "c2s", handler: "lib/project-sessions.js", description: "List GitHub accounts logged into the gh CLI" },
  "git_accounts_list":        { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Available GitHub accounts" },
  "get_project_git_account":  { direction: "c2s", handler: "lib/project-sessions.js", description: "Get a project's pinned GitHub account" },
  "project_git_account":      { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "A project's pinned GitHub account" },
  "set_project_git_account":  { direction: "c2s", handler: "lib/project-sessions.js", description: "Pin a project's git credentials to a GitHub account" },
  "set_project_git_account_result": { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Set project GitHub account result" },
  ...
  // -----------------------------------------------------------------------
  "workspace_get":            { direction: "c2s", handler: "lib/project-workspace.js", description: "Request the workspace context (links, media, worktree, dev) for the active session" },
  "workspace_state":          { direction: "s2c", handler: "lib/public/modules/workspace-panel.js", description: "Workspace context state for the active session" },
  "workspace_context":        { direction: "s2c", handler: "lib/public/modules/workspace-panel.js", description: "Live context patch (branch/worktree/dev) pushed when the agent switches worktree mid-turn" },
  "workspace_dev_start":      { direction: "c2s", handler: "lib/project-workspace.js", description: "Start the project's dev server in a terminal" },
  "workspace_dev_stop":       { direction: "c2s", handler: "lib/project-workspace.js", description: "Stop the project's dev server" },
  "workspace_dev_status":     { direction: "s2c", handler: "lib/public/modules/workspace-panel.js", description: "Dev server running/port status" },
  "workspace_tasks_get":      { direction: "c2s", handler: "lib/project-workspace.js", description: "Request the current Workspace task projection" },
  "workspace_tasks_state":    { direction: "s2c", handler: "lib/public/modules/workspace-panel.js", description: "Current Workspace task projection" },
  "workspace_pin_item":       { direction: "c2s", handler: "lib/project-workspace.js", description: "Pin a GitHub issue/PR to the active session" },
  "workspace_unpin_item":     { direction: "c2s", handler: "lib/project-workspace.js", description: "Unpin a GitHub issue/PR from the active session" },
  ...
  "live_ui_request_pair":     { direction: "c2s", handler: "lib/project-live-ui.js", description: "Request a server-authorized Live UI pairing or safe same-root dev-server reconnect" },
  "live_ui_probe_target":     { direction: "c2s", handler: "lib/project-live-ui.js", description: "Resolve the inspected local server to an accessible registered project and worktree" },
  "live_ui_target_workspace": { direction: "s2c", handler: "lib/public/modules/live-ui-messages.js", description: "Server-authoritative project/worktree match for an inspected Live UI target" },
  "live_ui_create_bound_session": { direction: "c2s", handler: "lib/project-live-ui.js", description: "Create and pair a coordinator chat bound to the inspected target workspace" },
  "live_ui_relay":            { direction: "both", handler: "lib/project-live-ui.js", description: "Versioned Live UI selection, report, status, and lifecycle relay envelope" },
  "live_ui_state":            { direction: "s2c", handler: "lib/public/modules/live-ui-messages.js", description: "Authoritative Live UI pairing lifecycle state" },
  "live_ui_selection":        { direction: "s2c", handler: "lib/public/modules/live-ui-messages.js", description: "Sanitized selected-element packet for the paired control session" },
  ...
  // Debate
  // -----------------------------------------------------------------------
  "debate_start":             { direction: "c2s", handler: "lib/project.js", description: "Start a new debate or restart a fresh debate from a persisted ended brief (restartBrief)" },
  ...
  "debate_pause":             { direction: "c2s", handler: "lib/project.js", description: "Pause/resume the debate turn chain at the next boundary ({paused: bool})" },
  ...
  "debate_pause_state":       { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Debate pause state changed ({paused, holding})" },
  "debate_proposal_pending":  { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Still-pending debate proposal re-sent on connect so the approval card survives reloads (F-7)" },
  "set_lead_mode":            { direction: "c2s", handler: "lib/project-sessions-user-state.js", description: "Set the server-authoritative Lead mode ({enabled: bool}); owner/admin only" },
  "set_lead_mode_result":     { direction: "s2c", handler: "lib/public/modules/app-messages-settings.js", description: "Authoritative Lead mode mutation result" },
  "lead_mode_changed":        { direction: "s2c", handler: "lib/public/modules/app-messages-settings.js", description: "Server-authoritative Lead mode state (sent on connect and broadcast after changes)" },
  "debate_conclusion":        { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Structured debate synthesis (recommendation, key arguments, dissents, open questions)" },
