...
var schema = {
  ...
  "list_cli_sessions":       { direction: "c2s", handler: "lib/project-sessions.js", description: "List importable Claude/Codex/Copilot CLI sessions for the requested vendor filter" },
  "import_cli_session":      { direction: "c2s", handler: "lib/project-sessions.js", description: "Import a CLI session by cliSessionId (clears tombstone, creates Clay record)" },
