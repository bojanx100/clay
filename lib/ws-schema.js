...
var schema = {
  ...
  "handoff_session_options":  { direction: "both", handler: "lib/project-sessions.js", description: "Request or return installed vendors, models, and effort options for a new-session handoff" },
  "handoff_session":          { direction: "c2s", handler: "lib/project-sessions.js", description: "Switch provider in place, or create a linked successor when handoffMode is new-session" },
  "session_handoff_result":   { direction: "s2c", handler: "lib/public/modules/session-actions.js", description: "Result of creating a linked successor session" },
  "handoff_context":          { direction: "s2c", handler: "lib/public/modules/session-actions.js", description: "Timeline marker linking a successor session to its source" },
  "handoff_created":          { direction: "s2c", handler: "lib/public/modules/session-actions.js", description: "Timeline marker linking a source session to its successor" },
