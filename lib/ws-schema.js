...
var schema = {
  ...
  "set_lead_mode":            { direction: "c2s", handler: "lib/project-sessions-user-state.js", description: "Toggle the per-user Lead (CTO orchestrator) opt-in ({enabled: bool}); off by default" },
  "set_lead_mode_result":     { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Result of set_lead_mode" },
  "lead_mode_changed":        { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Current per-user Lead mode state (sent on connect and after changes)" },
