...
function replayRestoredSession(ctx, ws, active) {
  ...
  var replay = coopTopicConnection.replayTopicSelection(ctx, ws, active);
  ctx.sm.replayHistory(replay && replay.replaySession || active, undefined, ws, ctx.hydrateImageRefs, replay ? replay.options : null);
