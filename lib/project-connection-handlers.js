...
function sendUserPreferenceState(ctx, ws, wsUser) {
  ...
  var leadState = leadModeModule.publicState(leadModeModule.getLeadModeState({ usersModule: usersModule }));
  leadState.type = "lead_mode_changed";
  leadState.canChange = leadModeModule.isAuthority(wsUser || null, usersModule.isMultiUser());
