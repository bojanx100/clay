...
function workerDetailFor(task, projectRef, destination, awaiting) {
  var sessionRef = destination && destination.ref || null;
  ...
  for (var s = 0; s < sessions.length; s++) {
    ...
    for (var t = 0; t < tasks.length; t++) {
      ...
      items.push({
        ...
        workerDetail: workerDetailFor(task, projectRef, destination, awaiting),
        links: linksFor(task),
