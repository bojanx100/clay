...
var formatters = {
  ...
  needs_input: function (data) {
    return {
      type: "needs_input",
      title: data.title || "Task needs your input",
      body: data.preview || "",
      meta: { sessionId: data.sessionId || null },
    };
  },

  task_completed: function (data) {
    return {
      type: "task_completed",
      title: data.title || "Task complete",
      body: data.preview || "",
      meta: { sessionId: data.sessionId || null, autoKind: data.autoKind || "issue" },
    };
  },
