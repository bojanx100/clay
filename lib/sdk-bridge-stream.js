...
// Codex (app-server) emits NO notifications while the model reasons between
// items — silent gaps of 30-60s+ are NORMAL for reasoning models on complex
// tasks. The recovery log showed the 30s mid-stream watchdog repeatedly
// killing healthy Codex turns at 30-35s of silence (case=mid-generation),
// then auto-resume started a fresh conversation that went silent reasoning
// again → killed again — a loop that burned tokens and spammed "Connection
// dropped… Resuming…" bubbles without making progress. Claude streams
// continuously, so 30s of true silence there stays anomalous; Codex gets a
// budget that accommodates silent reasoning.
