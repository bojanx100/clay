...
function attachSessionLoader(ctx) {
  ...
  function loadSessions() {
    ...
    for (var li = 0; li < loaded.length; li++) {
      ...
      if (loaded[li].migrated || session._archivedCompletedTaskOnLoad || session.interruptedByRestart || (session.vendor || null) !== (m.vendor || null) || (session.cliSessionId || null) !== (m.cliSessionId || null) || (session.handoffContext && !m.handoffContext)) {
