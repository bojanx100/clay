...
function attachSessionLoader(ctx) {
  ...
  function hydrateSession(m, history, fileMtime, summary) {
    ...
    if (m.contextRecovery && typeof m.contextRecovery === "object") session.contextRecovery = m.contextRecovery;
    ...
    if (m.coordinatorContextReceipt) session.coordinatorContextReceipt = m.coordinatorContextReceipt;
