...
function attachMessageProcessor(ctx) {
  ...
  function processSDKMessage(session, parsed) {
    ...
    if (parsed.yokeType === "turn_start") {
      ...
      if (session._turnSawActivity && !isZeroCost && session._consecutiveAutoResumes) {
      ...
      if (session._turnSawActivity && !isZeroCost && session.handoffContext) {
      ...
      if (session._turnSawActivity && !isZeroCost) {
