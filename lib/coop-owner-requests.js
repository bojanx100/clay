...
// project, same task, and the immediately next `bindingRevision` -- so an
// approval can never be replayed sideways onto another task or project, walked
// backwards onto a revision the owner has already seen the outcome of, or skip
