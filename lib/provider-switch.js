...
function attachProviderSwitch(ctx) {
  ...
  function targetRouteFailure(params, targetRoute, toVendor, requestedTargetModel) {
    ...
    if (requestedTargetModel && targetRoute && !verifiedRouteHasModel(targetRoute, requestedTargetModel)) {
      return {
        ok: false,
  ...
  function switchingToSameTarget(session, fromVendor, toVendor, targetRoute) {
    return fromVendor === toVendor && (!targetRoute || session.providerRouteId === targetRoute.id);
  }
  ...
  function executeProviderSwitch(params) {
    ...
    if (switchingToSameTarget(session, fromVendor, toVendor, targetRoute)) {
