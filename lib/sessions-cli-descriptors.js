...
function attachSessionCliDescriptors(ctx) {
  ...
  function readCodexSessionDescriptor(rolloutPath) {
    ...
    // Debate moderator/panelist worker sessions are backstage plumbing;
    // their transcripts already live in the debate itself.
    if (isDebateWorkerPrompt(firstUserText)) return null;
