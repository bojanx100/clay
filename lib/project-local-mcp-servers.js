...
function requestBrowserExtensionReconnect(clients, browserState) {
  if (browserState._extensionWs && browserState._extensionWs.readyState === 1) {
    return Promise.resolve({ connected: true, requestedClients: 0 });
  }
      ...
      try {
        ...
        var browserToolDefs = browserMcp.getToolDefs(sendExtensionCommandAny, function () {
          ...
          reconnectExtension: function () {
            return requestBrowserExtensionReconnect(clients, browserState);
          },
