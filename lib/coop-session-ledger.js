...
function bindingSummary(binding) {
  ...
  if (record.ownerAcceptanceRepair) {
    summary.ownerAcceptanceRepair = clone(record.ownerAcceptanceRepair);
  }
...
function buildEntry(input) {
  ...
  var status = lifecycleState(session, binding, task, role, input.taskBindings, input.sessions);
