...
// Disabled by default. The core predicate requires positive evidence of death,
// but activation still changes durable Lead state and therefore has its own
// explicit switch rather than piggybacking on the adapter idle reaper above.
var EXECUTION_REAPER_MS = Number(process.env.CLAY_COOP_EXECUTION_REAPER_MS) || 60 * 1000;
var executionReaperHandle = null;
if (process.env.CLAY_COOP_EXECUTION_REAPER === "1") {
