...
function attachMateInteraction(ctx) {
  ...
  function loadMateClaudeMd(mateCtx, mateId) {
    // getMateDir path.joins the id — a null/undefined mateId throws a
    // TypeError that has crashed the daemon (2026-07-31, MCP debate with no
    // moderator mate). No mate id means no identity file: return empty.
