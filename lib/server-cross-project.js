...
function createCrossProjectRouter(opts) {
  ...
  function sessionForBinding(binding) {
    var record = binding || {};
    var ref = record.mode === "project_coordinator" ? record.coordinator : record.worker;
    ...
    return portfolioBindings.sessionByRef(manager, ref,
      record.targetProject && record.targetProject.projectId || "");
  }
