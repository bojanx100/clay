...
// Prefers the backlog's own candidateKey (e.g. "launch:trialview/v2#2522") and
// falls back to the canonical GitHub coordinates, so an item reaching staffing
// by either route resolves to the same identity.
function workIdentityForItem(item) {
  if (!item || typeof item !== "object") return "";
  var candidateKey = typeof item.candidateKey === "string" ? item.candidateKey.trim() : "";
  ...
  return number ? "github:" + project + "#" + number : "";
}
