...
function createCandidateAdmission(options) {
  ...
  function briefFor(candidate) {
    ...
    context.push("This project's own automation policy classified the internal work as " +
      "autonomous. External actions keep their configured approval, claim, or deny gates.");
    return {
