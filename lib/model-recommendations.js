...
function buildModelRecommendationPrompt(vendor, model) {
  ...
  return [
    ...
    "For simple questions, status requests, and small reversible edits, complete the task directly with the selected model. Skip model-switch suggestions, extra workers, and broad workflows unless explicitly requested or necessary to verify the change.",
