...
export function initMisc() {
  ...
  confirmSecondary.addEventListener("click", function () {
    if (confirmSecondaryCallback) confirmSecondaryCallback();
    hideConfirm();
  });
...
export function showConfirm(text, onConfirm, okLabel, destructive, secondaryLabel, onSecondary, cancelLabel) {
  ...
  confirmSecondaryCallback = typeof onSecondary === "function" ? onSecondary : null;
  confirmSecondary.textContent = secondaryLabel || "Continue";
  confirmSecondary.classList.toggle("hidden", !confirmSecondaryCallback);
