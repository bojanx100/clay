import { handleWorkspaceState, handleWorkspaceDevStatus, handleWorkspaceContext, handleWorkspaceTasksState } from './workspace-panel.js';
...
import { applyCoopOwnerLedgerDetailResult } from './coop-owner-sidebar.js';
...
export function handleWorkspaceMessage(msg) {
  switch (msg.type) {
    ...
    case "workspace_tasks_state":
      handleWorkspaceTasksState(msg);
      return true;

    case "coop_owner_ledger_detail_result":
      store.set({ coopOwnerLedgerDetails: applyCoopOwnerLedgerDetailResult(
        store.get("coopOwnerLedgerDetails"), msg) });
      return true;
