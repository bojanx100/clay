...
import { coopProjectSignature, createCoopChannelsSection, regularCoopSessions, waitForCoopSessionMetadata } from './sidebar-coop-channels.js';
import {
...
function currentSessionListSignature() {
  ...
  return store.get('currentSlug') === "lead" ? signature + "|" + coopProjectSignature() : signature;
}
...
function buildCurrentSessionListModel() {
  var modelSessions = store.get('currentSlug') === "lead" ? regularCoopSessions(cachedSessions) : cachedSessions;
  var model = buildSessionListModel(modelSessions, {
...
export function renderSessionList(sessions) {
  ...
  var listEl = getSessionListEl();
  if (waitForCoopSessionMetadata(cachedSessions, store.get('currentSlug'))) {
    listEl.innerHTML = "";
    return;
  }
  ...
  if (store.get('currentSlug') === "lead") {
    var coopSection = createCoopChannelsSection({
    ...
    if (coopSection) listEl.appendChild(coopSection);
  }
