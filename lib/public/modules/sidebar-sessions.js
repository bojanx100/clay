...
import { appendSessionCloseButton, clearArmedSessionDelete, confirmDeleteSession } from './sidebar-sessions-delete.js';
import { createSessionGroupHeader } from './sidebar-sessions-group-header.js';
import { sendSessionBookmark, setupBookmarkDropTarget, setupSessionDragHandlers } from './sidebar-sessions-drag.js';
...
function getTopActionDeps() {
  return {
    hasMenu: function () { return !!sessionCtxMenu; },
    closeMenu: closeSessionCtxMenu,
    setMenu: function (menu) { sessionCtxMenu = menu; },
  };
}
