...
// Single entry point for session creation from the sidebar. The optimistic
// lastVendor write keeps the split button's icon from lagging a round-trip
// behind the click; the server echoes last_vendor to confirm.
