...
function appendProjectedProject(container, project) {
  ...
  next.className = "global-coop-next-action";
  next.textContent = "Next: " + project.summary.nextAction;
  group.appendChild(next);
  var actions = document.createElement("div");
  actions.className = "global-coop-project-actions";
  var openChannel = document.createElement("button");
  openChannel.type = "button";
  openChannel.className = "global-coop-channel-action";
  openChannel.textContent = "Open project channel";
  openChannel.addEventListener("click", function () { requestProjectChannel(project, sendUserAction); });
  actions.appendChild(openChannel);
