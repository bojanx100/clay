...
import { coopHeaderTitle, isCoopProjectSlug } from './coop-identity.js';
...
export function updatePageTitle() {
  ...
  // Fall back to the active session's title from the store when it isn't in the
  // visible list (hidden/archived sessions, e.g. a completed PR review opened
  // from the activity feed) — otherwise the header would drop to the project
  // name or keep a stale title.
  else if (store.get('activeSessionId')) sessionTitle = store.get('activeSessionTitle') || "";
