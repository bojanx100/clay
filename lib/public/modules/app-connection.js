...
import { notifyOwnerRequestsReconnect } from './coop-owner-requests-refresh.js';
...
export function connect(options) {
  ...
  newWs.onopen = function () {
    ...
    notifyCoopReconnect();
    // The owner-request backlog we hold was fetched over a socket that is now
    // gone, so re-ask on this one rather than showing the old answer.
    notifyOwnerRequestsReconnect();
    reconnectDelay = 1000;
    consecutive401s = 0;
