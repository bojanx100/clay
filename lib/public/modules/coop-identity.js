...
export var UNTITLED_TOPIC = "Untitled topic";
...
// Resolves the identity shown in the chat header / title bar. Inside Coop the
// answer is fixed, so no caller can reintroduce the flip by passing a session
// title through. Elsewhere the candidate wins and the caller's fallback applies.
...
// "q3-planning" -- and degrade them to "Untitled topic", which is a worse and
