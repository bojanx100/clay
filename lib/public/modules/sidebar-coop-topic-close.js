...
export function createTopicMenu(topic, options) {
  ...
  var title = topic ? canonicalTopicTitle(topic, "topic") : "topic";
  ...
  toggle.setAttribute("aria-label", "Topic options for " + title);
  ...
  list.setAttribute("aria-label", "Topic options for " + title);
  list.hidden = true;
  ...
  item.textContent = closed ? "Reopen topic" : "Close topic…";
  item.setAttribute("aria-label", (closed ? "Reopen topic " : "Close topic ") + title);
