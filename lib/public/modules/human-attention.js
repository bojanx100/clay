  ...
  wrap.innerHTML =
    ...
    '<section id="human-attention-popover" class="human-attention-popover hidden" role="dialog" aria-modal="false" aria-labelledby="human-attention-title">' +
      ...
      '<div class="human-attention-body">' +
        ...
        '<p>Phone foreground and desktop focused use include a 5-minute continuity window for brief locks, backgrounding, and disconnects. Longer unattended AI work is excluded.</p>' +
      '</div>' +
    '</section>';
