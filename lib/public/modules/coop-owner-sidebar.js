...
export function renderCoopOwnerSidebar(container, sidebar, options) {
  ...
  // "Needs attention" and "Working now" together are exactly that set. Actionable
  // work leads; settled work follows, so a landed or dropped ask stays auditable
  // without competing with the outstanding backlog for the top of the panel.
