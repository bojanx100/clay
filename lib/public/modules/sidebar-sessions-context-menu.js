...
export function showSessionCtxMenu(anchorBtn, sessionId, title, cliSid, sessionData) {
  ...
  var isPermanentCoopHome = !!(sessionData && sessionData.coopHome);
  ...
  if ((!store.get('permissions') || store.get('permissions').sessionDelete !== false) && !isPermanentCoopHome) {
    ...
    deleteItem.addEventListener("click", function (e) {
      e.stopPropagation();
      closeSessionCtxMenu();
      confirmDeleteSession({ id: sessionId, title: title, coopHome: isPermanentCoopHome });
    });
