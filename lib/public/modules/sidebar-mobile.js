...
function renderSheetSessions(listEl) {
  // Coop already supplies its own project-grouped conversation navigation.
  // Do not stack the generic project picker above that primary chat list.
...
function appendMobileProjectedProject(container, project) {
  ...
  var projectId = project.projectRef && project.projectRef.projectId || "";
  var heading = document.createElement("div");
  heading.className = "mobile-global-coop-project-heading";
  heading.id = "mobile-coop-project-" + String(projectId).replace(/[^a-zA-Z0-9_-]/g, "-");
  heading.setAttribute("role", "heading");
  heading.setAttribute("aria-level", "2");
  heading.textContent = (project.icon ? project.icon + " " : "") + project.title;
