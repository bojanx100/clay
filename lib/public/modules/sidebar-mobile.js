...
function appendMobileProjectedProject(container, project) {
  ...
  next.className = "mobile-global-coop-next-action";
  next.textContent = "Next: " + project.summary.nextAction;
  group.appendChild(next);
  var actions = document.createElement("div");
  actions.className = "mobile-global-coop-actions";
  var channel = document.createElement("button");
  channel.type = "button";
  channel.className = "mobile-global-coop-channel-action";
  channel.textContent = "Open project channel";
  channel.addEventListener("click", function () { requestProjectChannel(project, sendUserAction); });
