...
export function coopTopicSections(model) {
  ...
  var controlResults = Array.isArray(value.controlPlaneResults) ? value.controlPlaneResults : [];
  ...
  for (var ri = 0; ri < roles.length; ri++) {
    ...
    var results = controlResults.filter(function (result) {
      return result && result.role === roles[ri].role;
