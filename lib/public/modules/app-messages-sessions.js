...
export function handleSessionMessage(msg) {
  switch (msg.type) {
    case "coop_handoff_intent":
      rememberCoopHandoffIntent(msg);
      return true;
    case "session_list":
