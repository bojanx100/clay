...
import { projectApprovalPresentation } from './auto-approval-panel.js';
...
var autoApprovalProjectsSection = null;
var autoApprovalProjects = null;
...
function renderAutoApproval() {
  ...
  if (autoApprovalSummary) {
    ...
    else if (coop) autoApprovalSummary.textContent = "Choose automatic approval one project at a time.";
  ...
  if (autoApprovalProjectsSection) autoApprovalProjectsSection.classList.toggle("hidden", !coop || !state);
  if (!coop && state) {
  ...
  if (autoApprovalProjects) autoApprovalProjects.replaceChildren();
  if (coop && autoApprovalProjects && state) {
    var projects = projectApprovalPresentation(state);
    if (!projects.length) {
      var empty = document.createElement("p");
      empty.className = "auto-approval-projects-empty";
      empty.textContent = "No projects are available to manage yet.";
      autoApprovalProjects.appendChild(empty);
    }
    for (var i = 0; i < projects.length; i++) {
      var project = projects[i];
      var row = document.createElement("div");
      row.className = "auto-approval-project";
      var copy = document.createElement("div");
      copy.className = "auto-approval-project-copy";
      var label = document.createElement("strong");
      label.className = "auto-approval-project-name";
      label.textContent = project.name;
      var status = document.createElement("span");
      status.className = "auto-approval-project-status";
      status.textContent = project.statusLabel;
      var source = document.createElement("span");
      source.className = "auto-approval-project-source";
      source.textContent = project.sourceLabel;
      copy.appendChild(label);
      copy.appendChild(status);
      copy.appendChild(source);
      var button = document.createElement("button");
      button.className = "auto-approval-project-action";
      button.textContent = project.actionLabel;
      button.setAttribute("aria-label", project.actionLabel + " for " + project.name);
      ...
      })(project.projectRef, project.enabled));
      row.appendChild(copy);
      row.appendChild(button);
      autoApprovalProjects.appendChild(row);
    }
  }
}
...
export function initPanels() {
  ...
  autoApprovalProjectsSection = $("auto-approval-projects-section");
  autoApprovalProjects = $("auto-approval-projects");
