...
// Explicit text when there is real linked evidence, and nothing at all when
// there is not. Falling back to Working labelled every row identically, which
// is worse than silence: it asserts something untrue about work that does not
// exist.
