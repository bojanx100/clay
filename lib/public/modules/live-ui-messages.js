...
import {
  forwardLiveUiPickerState,
  forwardLiveUiTargetWorkspace,
} from './live-ui-extension-picker.js';
...
export function handleLiveUiMessage(msg) {
  ...
  if (msg.type === "live_ui_target_workspace") {
    forwardLiveUiTargetWorkspace(msg);
    return true;
  }
