...
function requestHandoffDialog() {
  closeMenu();
  sendUserAction({ type: "handoff_session_options" });
}
...
function showHandoffDialog(options) {
  ...
  submit.addEventListener("click", function () {
    var sent = sendUserAction({
      type: "handoff_session",
      handoffMode: "new-session",
...
function showMainMenu() {
  ...
  var handoff = actionRow("send", "Continue in a new agent", "Start a linked session with this conversation's context.");
  handoff.classList.add("is-primary");
