...
export function topicReviewVerbs(topic) {
  ...
  var topicScoped = source === "unlinked_default" || source.indexOf("owner_disposition:") === 0;
...
function buildPanel(topic, verbs, prefix, id) {
...
export function createTopicReviewControl(topic, options) {
  ...
  if (open) wrapper.appendChild(buildPanel(topic, verbs, prefix, id));
  return wrapper;
}
