...
import { syncPaneTitles, maybeRestoreSplitGroup } from './split-view.js';
...
import { resolvePaneSession } from './pane-session.js';
...
export function processMessage(msg) {
    ...
    switch (msg.type) {
      ...
      case "session_switched":
        ...
        store.set({ activeSessionId: msg.id, cliSessionId: msg.cliSessionId || null, currentModel: msg.model || store.get('currentModel'), vendorCapabilities: msg.capabilities || {}, sessionIsProcessing: !!msg.isProcessing, activeSessionMode: _effectiveMode, activeTerminalId: _effectiveTerminalId, sessionHasHistory: !!msg.hasHistory });
