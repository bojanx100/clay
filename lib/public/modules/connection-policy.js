...
// Choose the session identity attached to a new project socket. Ordinary
// projects restore the conversation last visited in this browser tab. Coop
// always opens its canonical main conversation unless the URL carries an
// explicit durable reference. Reconnects fall back to the active conversation
// when this tab has not remembered one yet.
